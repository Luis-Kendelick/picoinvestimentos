...
const ThirdSection = () => {
  ...
  return (
    <div className="h-fit w-full z-30 bg-darkbg overflow-x-hidden">
      <div className='bg-picoLightGreen/70 h-full w-full flex flex-col p-12 pb-6 px-8 md:p-48 md:py-12 justify-center md:justify-start'>
        ...
        <h2 className="mt-1 text-lg md:text-xl text-primary text-end md:text-center">
          Principais áreas de atuação: {window.innerWidth < 765 && <br />}
          <motion.strong
            ref={tributeRef}
            initial={{
              opacity: 0.2,
