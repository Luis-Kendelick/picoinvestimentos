                ...
                <div className='flex justify-around flex-wrap w-full gap-5'>
                    <div className='flex justify-around flex-wrap w-full gap-5'>
                        <div className='p-5 bg-slate-700 rounded-md cursor-pointer w-full md:max-w-[48%] flex justify-between items-center'>
                            ...
                            <DownloadIcon className='h-7 w-7 p-1 transition-colors duration-200 hover:bg-slate-400 rounded-md' onClick={() => downloadPDF(pdfs.find(pdf => pdf.name === 'termo-de-uso.docx')?.path ?? '')} />
                        </div>
                    </div>
                </div>
            </div>
